...
const BuyingStatusDetailScreen = ({ navigation, route }) => {
  ...
  const [submitRequest] =
    type == 'add'
      ? useAddBuyingStatusMutation({
          fixedCacheKey: 'add-buying-status',
        })
      : useEditBuyingStatusMutation({
          fixedCacheKey: 'edit-buying-status',
        })
  ...
  React.useEffect(() => {
    ...
    switch (type) {
      case 'add':
        tempScreen = { isDisabled: false, title: t('addBuyingStatus') }
        break
      case 'edit':
        tempScreen = { isDisabled: false, title: t('editBuyingStatus') }
        break
      case 'view':
        tempScreen = { isDisabled: true, title: t('buyingStatusDetail') }
        break
      default:
...
export default BuyingStatusDetailScreen
