...
const BuyingTypeDetailScreen = ({ navigation, route }) => {
  ...
  React.useEffect(() => {
    ...
    switch (type) {
      case 'add':
        tempScreen = { isDisabled: false, title: t('addBuyingType') }
        break
      case 'edit':
        tempScreen = { isDisabled: false, title: t('editBuyingType') }
        break
      case 'view':
        tempScreen = { isDisabled: true, title: t('buyingTypeDetail') }
        break
      default:
...
export default BuyingTypeDetailScreen
