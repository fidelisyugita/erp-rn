...
const TransactionStatusDetailScreen = ({ navigation, route }) => {
  ...
  React.useEffect(() => {
    ...
    switch (type) {
      case 'add':
        tempScreen = { isDisabled: false, title: t('addTransactionStatus') }
        break
      case 'edit':
        tempScreen = { isDisabled: false, title: t('editTransactionStatus') }
        break
      case 'view':
        tempScreen = { isDisabled: true, title: t('transactionStatusDetail') }
        break
      default:
...
export default TransactionStatusDetailScreen
