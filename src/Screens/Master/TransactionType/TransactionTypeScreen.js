...
const TransactionTypeScreen = ({ navigation }) => {
  ...
  ] = usePagination(useLazyGetTransactionTypesQuery)
  ...
  const [
    ...
    fixedCacheKey: 'add-transaction-type',
  })
  ...
  React.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight: () => (
        <IconButton
          onPress={() => {
            navigation.navigate('MasterTransactionTypeDetailScreen', {
              type: 'add',
            })
          }}
          key="ghost"
  ...
  return (
    <Box flex="1" bgColor="white" paddingX="4">
      <Input
        ref={searchRef}
        placeholder={t('searchTransactionType')}
        width="100%"
        borderRadius="4"
        py="3"
        px="1"
