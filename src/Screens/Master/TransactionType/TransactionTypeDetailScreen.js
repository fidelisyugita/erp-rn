...
const TransactionTypeDetailScreen = ({ navigation, route }) => {
  ...
  const [submitRequest] =
    type == 'add'
      ? useAddTransactionTypeMutation({ fixedCacheKey: 'add-transaction-type' })
      : useEditTransactionTypeMutation({
          fixedCacheKey: 'edit-transaction-type',
        })
  ...
  React.useEffect(() => {
    ...
    switch (type) {
      case 'add':
        tempScreen = { isDisabled: false, title: t('addTransactionType') }
        break
      case 'edit':
        tempScreen = { isDisabled: false, title: t('editTransactionType') }
        break
      case 'view':
        tempScreen = { isDisabled: true, title: t('transactionTypeDetail') }
        break
      default:
...
export default TransactionTypeDetailScreen
